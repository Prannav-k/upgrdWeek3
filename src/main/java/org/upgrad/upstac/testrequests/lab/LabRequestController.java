...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        /**Status*/
        RequestStatus initiatedStatus = RequestStatus.INITIATED;
        /**Query*/
        List<TestRequest> testRequests= testRequestQueryService.findBy(initiatedStatus);
        /**Return*/
        return testRequests;
    ...
    public List<TestRequest> getForTester()  {
        ...
        /**Fetch all tests with above user as tester*/
        List<TestRequest> testRequestList=testRequestQueryService.findByTester(user);
        /**Return*/
