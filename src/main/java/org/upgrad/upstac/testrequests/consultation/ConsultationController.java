...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        /**Status*/
        RequestStatus initiatedStatus = RequestStatus.LAB_TEST_COMPLETED;
        /**Query*/
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        /**Fetch all tests with above user as Doctor*/
        List<TestRequest> testRequestList=testRequestQueryService.findByDoctor(user);
        /**Return*/
